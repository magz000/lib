            ...
            <div class="row justify-content-center p-5">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="text-primary">Add Employee</h3></div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.stores.addemployeeprocess', $id) }}">
                                {{ csrf_field() }}
